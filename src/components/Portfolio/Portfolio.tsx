...
import { Button, Card, CardContent, Typography, Grid, TextField, Stack, Box } from '@mui/material';
                        ...
                        <Card variant="outlined" style={{ padding: "5px", borderRadius: '10px' }}>
                            <CardContent>
                                ...
                                <Stack spacing={2} direction="row" style={{ float: 'right', marginBottom: "20px" }}>
                                    ...
                                    <Button color="secondary" onClick={() => navigate(`/event/${e.id!}`)} style={{ marginTop: '10px' }} variant="contained">TRADE</Button>
